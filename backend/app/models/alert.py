...
class Alert(Base):
    ...
    )  # vulnerability, exposure, anomaly, threat, compliance
    ...
    assigned_to = relationship(
        "User", foreign_keys=[acknowledged_by], backref="assigned_alerts"
    )
    ...
    def is_escalated(self) -> bool:
        return (
            self.severity in (AlertSeverity.CRITICAL, AlertSeverity.HIGH)
            and self.status == AlertStatus.OPEN
        )
